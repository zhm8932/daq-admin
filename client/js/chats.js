define(function (require, exports, module) {
    ...
    function loginEaseMob() {
        var password = $('#user-list').attr('data-p')||$('.accountId').attr('data-imToken');
        var config = {
            user: masterId,
            pwd: password,
    ...
    function getChatHistory(obj) {
        ...
        if(masterId == fromUserId){
            customerId = toUserId;
            customerAccount = $(obj).closest('tr').find('.toUser').html()||$(obj).closest('tr').attr('data-toUserId');
        }else{
            customerId = fromUserId;
            customerAccount = $(obj).closest('tr').find('.fromUser').html()||(obj).closest('tr').attr('data-fromUserId');
        }
