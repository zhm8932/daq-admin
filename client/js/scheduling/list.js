define(function(require,exports,module) {
    ...
    $body.on('click','.editBtn',function () {
        var $self = $(this);
        var $isSets = $self.parents('tr').find('.isSet');
        ...
        $self.addClass('saveBtn').removeClass('editBtn').html('保存')

        $.each($isSets,function (index,item) {
    ...
    $body.on('click','.saveBtn',function () {
        ...
        var $trP = $self.parent().parent();
        serializeObj = {
            "doctorId": $trP.attr('data-doctorid'),
            "hospitalId": $trP.attr('data-hospitalid')
        }
        $.each($SelectInput,function (index,item) {
            ...
            sourceList.push({
                ...
                "scheduleDate":  $parentTd.attr('data-day')
            })
        })
        ...
        $.ajax({
            type:'post',
            data:serializeObj,
            url:'/scheduling/numbers/add_schedule_batch',
            success:function(json){
                console.log(json)
                var json = JSON.parse(json);
                if(json.success){
                    ...
                    $self.addClass('editBtn').removeClass('saveBtn').html('修改')
